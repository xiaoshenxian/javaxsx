 ...
 * {
 * 	&#064;code
 * 	RuntimeTypeAdapter&lt;Shape&gt; shapeAdapter=RuntimeTypeAdapterFactory.of(Shape.class).registerSubtype(Rectangle.class).registerSubtype(Circle.class).registerSubtype(Diamond.class);
 * }
 * </pre>
 */
public class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory
{
	 ...
	 * @param typeFieldName typeFieldName
	 * @return a {@link RuntimeTypeAdapterFactory} instance
	 */
	...
	public <R> TypeAdapter<R> create(Gson gson, TypeToken<R> type)
	{
		...
		return new TypeAdapter<R>() {
			...
			public R read(JsonReader in) throws IOException
			{
				...
				jsonReader.setLenient(in.isLenient());
			...
			public void write(JsonWriter out, R value) throws IOException
			{
				...
				jsonWriter.setLenient(out.isLenient());
				jsonWriter.setHtmlSafe(out.isHtmlSafe());
				jsonWriter.setSerializeNulls(out.getSerializeNulls());
				delegate.write(jsonWriter, value);
				JsonObject jsonObject=jsonWriter.get().getAsJsonObject();
