 ...
 * In most cases, the {@link Item} features are "modeled" at the same time when they are generated by any {@link Strategy}, thus the {@link #getModeler()} method is defaulted by return an {@link IdleModeler} which does nothing.
 * 
 * @author weikun.zhong
 *
